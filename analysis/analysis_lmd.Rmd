...
```{r}
lode_data <- grab_lodes(state = "dc", year = 2019, lodes_type = "od", job_type = "JT01",
...
dc_lode_data_wac <- grab_lodes(state = "dc", year = 2019, lodes_type = "wac", job_type = "JT01",
           segment = "S000", state_part = "aux", agg_geo = "tract")

dc_lode_data_rac <- grab_lodes(state = "dc", year = 2019, lodes_type = "rac", job_type = "JT01",
           segment = "S000", state_part = "aux", agg_geo = "tract")

head(dc_lode_data_wac)
